...
#' @param task (chr) The taks ChatGPT should assess
#' @param instructions (chr) Description of steps CahtCPG should follow
#' @param output (chr) The type/kind of outpur required
...
#' @param delimiter (chr) delimiters for the `text` to embedd, a sequence of
