#' Create a prompt to OpernAI API
#'
...
#'
#' @details
#' In genere, una conversazione è formattata con un messaggio di
#' sistema, seguito da messaggi alternati dell'utente e dell'assistente.
#'
...
#' @param usr_msg (chr) messaggio da usare come richiesta al sistema passata dall'utente
#'
